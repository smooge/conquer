 ...
 *
 * Total Functions Under Test: 28
 * Minimum Test Cases: 84 (3 per function: normal, boundary, extreme)
...
int main(void) {
    ...
    printf("Testing 28 functions from safe_convert.h\n");
    ...
    printf("\n=== Test Summary ===\n");
    printf("Total Functions Tested: 28\n");
